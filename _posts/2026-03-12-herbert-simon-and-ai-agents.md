...
![Bounded Rationality — Simon's core framework showing three constraints leading to satisficing]({{ '/assets/images/simon-bounded-rationality.svg' | relative_url }})
...
![Near-Decomposable Architecture — hierarchical modules with strong internal and weak external coupling]({{ '/assets/images/simon-near-decomposability.svg' | relative_url }})
...
![Simon's Seven Theories mapped to AI Agent Concepts]({{ '/assets/images/simon-seven-mappings.svg' | relative_url }})
